...
export type Pattern = "random" | "separate" | "mixed";
...
export default function Tool() {
  ...
  const setPlayerGroup = (playerId: number, group: "A" | "B" | null) => {
    setPlayers(players.map((p) => (p.id === playerId ? { ...p, group } : p)));
  };
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  if (checked) {
                    ...
                    setPlayers(players.map((p) => ({ ...p, group: null })));
                  }
                }}
        ...
        <div className="bg-[#2d2d2d] rounded-lg shadow-2xl p-6 md:p-8 border border-gray-700">
          <div className="flex justify-between items-center mb-6">
            ...
            >
              ...
              <span>{copySuccess ? "コピーしました！" : "結果を保存"}</span>
            </button>
          </div>
              ...
              >
                ...
                <div className="space-y-2">
                  {round.matches.map((match, i) => (
                    <div key={i} className="bg-[#252525] rounded-lg px-4 py-3">
